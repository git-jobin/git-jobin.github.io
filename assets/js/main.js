...
toggle.addEventListener('click', function() {
  ...
  if (nav.classList.contains('open')) {
    ...
    document.getElementById("hamburger").classList.add('fa-xmark');
    document.getElementById("overlay").classList.add("active");
  } else {
    document.getElementById("hamburger").classList.remove('fa-xmark');
...
function handleBubble(e) {
  ...
  if (hasAnyButtonHovered || e.target.classList.contains("bubble_expander")) {
